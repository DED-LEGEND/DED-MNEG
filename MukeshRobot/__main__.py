...
DONATE_STRING = f"""❍ ʜᴇʏ ʙᴀʙʏ, ʜᴀᴩᴩʏ ᴛᴏ ʜᴇᴀʀ ᴛʜᴀᴛ ʏᴏᴜ ᴡᴀɴɴᴀ ᴅᴏɴᴀᴛᴇ. ʏᴏᴜ ᴄᴀɴ ᴅɪʀᴇᴄᴛʟʏ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ @Dx_INFO ғᴏʀ ᴅᴏɴᴀᴛɪɴɢ ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴠɪsɪᴛ ᴍʏ sᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ @YARANA_TG ᴀɴᴅ ᴀsᴋ ᴛʜᴇʀᴇ ᴀʙᴏᴜᴛ ᴅᴏɴᴀᴛɪᴏɴ."""
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(text="𝙻𝚄𝙲𝙺𝚈 ", url="https://t.me/nykaa_update"),
                    ],
                    [
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴘᴅᴀᴛᴇ", url=f"https://t.me/DX_INFO"
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="ʜᴏᴍᴇ", callback_data="mukesh_back"),
    ...
    x=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ",
                            url="https://t.me/RemixDjBOT?startgroup=true"
                            )
                       ]
                ]
                     )
...
✦ㅤ{BOT_NAME} ɪs ᴀʟɪᴠᴇ ʙᴀʙʏ ✦
     ━━━━━━━━ 🝮✿🝮 ━━━━━━━━
**❅ ᴍᴀᴅᴇ ʙʏ ➛ [𝙳𝚇-𝙻𝚄𝙲𝙺𝚈](https://t.me/YARANA_TG)**
**❅ ᴘʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ ➛** `{y()}`
